...
class Character(Base):
    ...
    taboos: Mapped[list] = mapped_column(JSONB, default=list)
    catchphrases: Mapped[list] = mapped_column(JSONB, default=list)
...
class Format(Base):
    ...
    beat_sheet: Mapped[list] = mapped_column(JSONB, default=list)
